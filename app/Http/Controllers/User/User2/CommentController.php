...
use App\Http\Requests\User\User2\Comment\CreateCommentRequest;
use App\Services\User\User2\Comment\ListCommentService;
use App\Services\User\User2\Comment\StoreService;
use App\Services\User\User2\Recruitment\DetailService;
...
class CommentController extends Controller
{
    ...
    public function show ($slug)
    {
        try {
            ...
            return view('user.user2.recruitment.detail', [
