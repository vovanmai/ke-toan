...
use App\Http\Requests\User\User2\Auth\LoginRequest;
use App\Http\Requests\User\User2\Auth\RegisterUserRequest;
use App\Services\User\User2\Auth\LoginService;
use App\Services\User\User2\Auth\RegisterUserService;
use App\Services\User\User2\Auth\VerifyAccountService;
use Exception;
...
//            }
            return view('user.user2.auth.login', [
