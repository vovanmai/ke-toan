...
use App\Services\Admin\Slider\DeleteService;
use App\Services\Admin\Slider\DetailService;
use App\Services\Admin\Slider\ListService;
use App\Services\Admin\Slider\StoreService;
use App\Services\Admin\Slider\UpdateService;
...
class SliderController extends Controller
{
    ...
    public function store (CreateRequest $request)
    {
        ...
        try {
            ...
            session()->flash('success_message', 'Tạo slider thành công!');
    ...
    public function update (EditSliderRequest $request, int $id)
    {
        $data = $request->validated();
        ...
        try {
            ...
            session()->flash('success_message', 'Cập nhật slider thành công!');
