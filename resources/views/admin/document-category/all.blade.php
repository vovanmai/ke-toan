        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form class="form-horizontal" method="GET" action="{{ route('admin.document_category.list') }}">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{ route('admin.document_category.list') }}" type="button" class="btn btn-success">
                                <i class="fa fa-refresh"></i>
                                Làm mới
                            </a>
                            <a href="{{ route('admin.document_category.create') }}" type="button" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Tạo mới
                            </a>
                        </div>
                    </div>
                        ...
                        <div style="padding: 0px 50px">
                            ...
                            <div class="parent-cat cat-{{ $item->id }}">
                                ...
                                <div class="pull-right">
                                    ...
                                    ||
                                    <a style="color: #367fa9" href="{{ route('admin.document_category.edit', ['id' => $item->id]) }}">
