        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form id="create-recruitment-form" class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('admin.recruitment.store') }}">
                        @csrf
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-fw fa-search"></i>Tạo mới tuyển dụng</h3>
...
@push('script')
    <script>
        $(function() {
            $("#create-recruitment-form").validate({
                rules: {
                    title: {
                        required: true,
                        maxlength: 255,
                ...
                submitHandler: function(form) {
                    ...
                    var numberPreviewImage = $('#create-recruitment-form textarea[name="image"]').length;
