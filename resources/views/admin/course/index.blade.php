        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form id="search-recruitment-form" class="form-horizontal" method="GET" action="{{ route('admin.course.list') }}">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-fw fa-search"></i>Tìm kiếm khóa học</h3>
                        </div>
                    <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-fw fa-list-ul"></i>Danh sách khóa học</h3>
                        ...
                        @if ($items->count())
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th>Ảnh</th>
                                    <th style="width: 22%">Mô tả ngắn</th>
                                    <th>Active</th>
                                    <th>Lượt xem</th>
                                    <th>Ngày tạo</th>
                                    <th>Ngày cập nhập</th>
