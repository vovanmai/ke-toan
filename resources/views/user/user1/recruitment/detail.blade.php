                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="blog_details_wrapper">
                        <div class="blog_thumb">
                            <a href="#"><img src="{{ getPublicFile($recruitment->previewImage->store_name ?? '') }}" alt=""></a>
                        </div>
                        <div class="blog_content">
                            ...
                            <div class="post_meta">
                                ...
                                <span>|</span>
                                <span><i class="fa fa-calendar" aria-hidden="true"></i> {{ $recruitment->created_at }} </span>
                                    ...
                                    <div class="{{ "comment-$comment->id" }}">
                                        <div class="comment_list">
                                            <div class="comment_thumb">
                                                <img src="/assets/user/user1/img/comment_avatar.jpg" alt="">
                                            </div>
