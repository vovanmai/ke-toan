                ...
                <div class="offcanvas_menu_wrapper">
                    ...
                    <div class="top_right">
                        <ul>
                            ...
                            <li class="top_links"><a href="#">Setting<i class="fa fa-angle-down"
                            ...
                            <li class="language"><a href="#"><img src="/assets/user/user1/img/logo/language.png"
                                                                  alt="">English<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                <ul class="dropdown_language">
                                    <li><a href="#"><img src="/assets/user/user1/img/logo/language.png" alt=""> English</a></li>
                                    <li><a href="#"><img src="/assets/user/user1/img/logo/language2.png" alt=""> Germany</a>
                                    </li>
                                </ul>
                            </li>
