            ...
            <div class="row">
                <div class="col-lg-9 col-md-12">
                    <div class="blog_wrapper">
                        ...
                        <div class="single_blog highlight-border p-2">
                            <div class="blog_thumb">
                                <a href="{{ route('user.course.detail', ['slug' => $item->slug]) }}"><img src="{{ getPublicFile($item->image['store_name'] ?? null) }}" alt=""></a>
                            </div>
                            <div class="blog_content">
                                <h3><a href="{{ route('user.course.detail', ['slug' => $item['slug']]) }}">{{ $item->title }}</a></h3>
                                <div class="blog_meta">
                                ...
                                <div class="readmore_button">
                                    <a href="{{ route('user.course.detail', ['slug' => $item->slug]) }}">Chi tiết</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-lg-3 col-md-12 main-content">
                    <div>
