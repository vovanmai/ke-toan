                ...
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            ...
                            <li><a href="{{ route('user.course.index') }}">Thông tin khóa học</a></li>
                            <li>{{ $item->title }}</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="blog_details_wrapper">
                        ...
                        <div class="blog_content">
                            ...
                            <div class="post_meta">
                                ...
                                <span><a href="#">{{ $item->admin->name ?? null }}</a></span>
                                <span>|</span>
                                <span><i class="fa fa-calendar" aria-hidden="true"></i> {{ $item->created_at->format('H:i d/m/Y') }} </span>
                            </div>
                            @php
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="single_related">
                                        <div class="related_thumb">
                                            <img src="{{ $relatedCourse->image['url'] }}" alt="">
                                        </div>
                                        <div class="related_content">
                                            <h3><a href="{{ route('user.course.detail', ['slug' => $relatedCourse->slug]) }}">{{ $relatedCourse->title }}</a></h3>
                                            <span><i class="fa fa-calendar" aria-hidden="true"></i>
                                                {{ $relatedCourse->created_at }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div style="border-top: 1px solid #ededed; margin-top: 30px; padding-top: 20px">
                            ...
                            <div class="fb-comments" data-href="{{ route('user.course.detail', ['slug' => $item->slug]) }}" data-width="100%" data-numposts="5"></div>
                        </div>
                        @endif
                    </div>
                    <!--blog grid area start-->
