                    ...
                    <div class="blog_wrapper">
                        ...
                        <div class="single_blog highlight-border p-2">
                            <div class="blog_thumb">
                                <a href="{{ route('user.recruitment.detail', ['slug' => $recruitment->slug]) }}"><img src="{{ $recruitment->image['url'] ?? null }}" alt=""></a>
                            </div>
                            <div class="blog_content">
                                <h3><a href="{{ route('user.recruitment.detail', ['slug' => $recruitment->slug]) }}">{{ $recruitment->title }}</a></h3>
                                <div class="blog_meta">
                                    <span class="post_date"><i class="fa-calendar fa"></i> {{ $recruitment->created_at->format('H:i d/m/Y') }}</span>
