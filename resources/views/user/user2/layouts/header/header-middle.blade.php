            ...
            <div class="col-lg-2 col-md-6">
                <div class="logo">
                    <a href="{{ route('user.index') }}">
                        <img style="{{ $styleLogo }} object-fit: cover" src="{{ isset($webSetting->logo) ? $webSetting->logo['url'] : '/assets/user/user2/img/logo/logo.png' }}" alt="">
                    </a>
                </div>
            </div>
                    ...
                    <div class="main_menu menu_two">
                        <nav>
                            <ul>
                                ...
                                {{--<li class="mega_items"><a href="shop.html">shop<i
                                    ...
                                    <div class="mega_menu">
                                        ...
                                        <div class="banner_static_menu">
                                            <a href="shop.html"><img src="/assets/user/user2/img/bg/banner1.jpg" alt=""></a>
                                        </div>
                                    </div>
                                </li>--}}
                                ...
                                <li><a class="{{ request()->is('tuyen-dung') ? 'active' : '' }}" href="{{ route('user.recruitment.index') }}">Tuyển dụng</a></li>
                                <li><a class="{{ request()->is('thong-tin-khoa-hoc') ? 'active' : '' }}" href="{{ route('user.course.index') }}">Thông tin khóa học</a></li>
                                <li><a class="{{ request()->is('lien-he') ? 'active' : '' }}" href="{{ route('user.contact') }}">Liên hệ</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="customer_support">
                        ...
                        <div class="customer_support_text">
                            <p>
                                ...
                                <a href="tel:{{ $webSetting->customer_support_phone ?? null }}">{{ $sumPhone ?? null }}</a>
                            </p>
                        </div>
                    </div>
                </div>
