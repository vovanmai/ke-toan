                    ...
                    <div class="row align-items-lg-center">
                        <div class="col-lg-5 order-lg-2 mb-7 mb-lg-0">
                            ...
                            <div class="d-flex gap-2">
                                <a class="btn btn-primary rounded-pill btn-sm" href="#">$59 - Add to cart</a>
                                <a class="btn btn-outline-primary btn-icon rounded-circle btn-sm" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Save for later">
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <div class="w-75 mx-auto">
                                <img class="img-fluid" src="/assets/user/user3/img/mockups/img5.png" alt="Image Description">
                            </div>
                        </div>
                        <!-- End Col -->
                    </div>
            ...
            <div class="swiper-slide">
                ...
                <div class="container content-space-t-2 content-space-b-3">
                    <div class="row align-items-lg-center">
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <div class="w-75 mx-auto">
                                <img class="img-fluid" src="/assets/user/user3/img/mockups/img6.png" alt="Image Description">
                            </div>
                        </div>
                        <!-- End Col -->
                    </div>
            ...
            <div class="swiper-slide">
                ...
                <div class="container content-space-t-2 content-space-b-3">
                    <div class="row align-items-lg-center">
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <div class="w-75 mx-auto">
                                <img class="img-fluid" src="/assets/user/user3/img/mockups/img1.png" alt="Image Description">
                            </div>
                        </div>
                        <!-- End Col -->
                    </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a class="js-swiper-thumb-progress swiper-thumb-progress-avatar" href="javascript:;" tabindex="0">
                        <img class="swiper-thumb-progress-avatar-img" src="/assets/user/user3/img/160x160/img11.jpg" alt="Image Description">
                    </a>
                </div>
                <!-- End Slide -->
                <!-- Slide -->
                <div class="swiper-slide">
                    <a class="js-swiper-thumb-progress swiper-thumb-progress-avatar" href="javascript:;" tabindex="0">
                        <img class="swiper-thumb-progress-avatar-img" src="/assets/user/user3/img/160x160/img14.jpg" alt="Image Description">
                    </a>
                </div>
                <!-- End Slide -->
                <!-- Slide -->
                <div class="swiper-slide">
                    <a class="js-swiper-thumb-progress swiper-thumb-progress-avatar" href="javascript:;" tabindex="0">
                        <img class="swiper-thumb-progress-avatar-img" src="/assets/user/user3/img/160x160/img15.jpg" alt="Image Description">
                    </a>
                </div>
                <!-- End Slide -->
            </div>
