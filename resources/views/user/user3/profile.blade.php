...
@section('content')
    ...
    <main id="content" role="main" class="bg-light">
        <!-- Breadcrumb -->
        <div class="navbar-dark bg-dark" style="background-image: url(/assets/user/user3/svg/wave-pattern-light.svg);">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-none d-lg-block text-center mb-5">
                                        <div class="avatar avatar-xxl avatar-circle mb-3">
                                            <img class="avatar-img" src="/assets/user/user3/img/160x160/img9.jpg" alt="Image Description" />
                                            <img
                                                class="avatar-status avatar-lg-status"
                                                src="/assets/user/user3/svg/illustrations/top-vendor.svg"
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <label class="avatar avatar-xl avatar-circle" for="avatarUploader">
                                                    <img id="avatarImg" class="avatar-img" src="/assets/user/user3/img/160x160/img9.jpg" alt="Image Description" />
                                                </label>
                                          ...
                                          "resetImg": "/assets/user/user3/img/160x160/img1.jpg",
